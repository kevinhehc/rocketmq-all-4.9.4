...
public abstract class RebalanceImpl {
        ...
        switch (messageModel) {
            ...
            case CLUSTERING: {
                ...
                if (mqSet != null && cidAll != null) {
                    ...
                    // 在负载均衡之后，更新 ProcessQueue 和 PullRequest列表
     ...
     * @return offset
     */
    // 当网络不稳定时，使用该接口可能会返回错误的偏移量。建议使用 computePullFromWhereWithException。
    @Deprecated
