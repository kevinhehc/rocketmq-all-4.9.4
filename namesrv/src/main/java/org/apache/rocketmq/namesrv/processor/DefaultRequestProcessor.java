...
public class DefaultRequestProcessor extends AsyncNettyRequestProcessor implements NettyRequestProcessor {
    ...
    public RemotingCommand processRequest(ChannelHandlerContext ctx,
        ...
        switch (request.getCode()) {
            case RequestCode.PUT_KV_CONFIG: // 添加 kv 配置
                return this.putKVConfig(ctx, request);
            case RequestCode.GET_KV_CONFIG: // 获取 kv 配置
                return this.getKVConfig(ctx, request);
            case RequestCode.DELETE_KV_CONFIG: // 删除 kv 配置
                return this.deleteKVConfig(ctx, request);
            case RequestCode.QUERY_DATA_VERSION: // 获取 broker 主题配置 / 查询数据版本 hhc1 到底是哪个？
            ...
            case RequestCode.GET_ROUTEINFO_BY_TOPIC: // 通过主题获取路由信息
                return this.getRouteInfoByTopic(ctx, request);
            case RequestCode.GET_BROKER_CLUSTER_INFO: // 获取 broker 集群的信息
                return this.getBrokerClusterInfo(ctx, request);
            case RequestCode.WIPE_WRITE_PERM_OF_BROKER: // 抹除 broker 的 写权限
                return this.wipeWritePermOfBroker(ctx, request);
            case RequestCode.ADD_WRITE_PERM_OF_BROKER: // 添加 broker 的写权限
                return this.addWritePermOfBroker(ctx, request);
            case RequestCode.GET_ALL_TOPIC_LIST_FROM_NAMESERVER: // 获取所有的主题列表
                return getAllTopicListFromNameserver(ctx, request);
            case RequestCode.DELETE_TOPIC_IN_NAMESRV: // 删除主题
                return deleteTopicInNamesrv(ctx, request);
            case RequestCode.GET_KVLIST_BY_NAMESPACE: // 获取某命名空间下的 Kv列表
                return this.getKVListByNamespace(ctx, request);
            case RequestCode.GET_TOPICS_BY_CLUSTER: // 获取某集群下的主题
                return this.getTopicsByCluster(ctx, request);
            case RequestCode.GET_SYSTEM_TOPIC_LIST_FROM_NS: // 通过命名空间获取系统主题列表
                return this.getSystemTopicListFromNs(ctx, request);
            case RequestCode.GET_UNIT_TOPIC_LIST: // 获取唯一的主题列表
                return this.getUnitTopicList(ctx, request);
            case RequestCode.GET_HAS_UNIT_SUB_TOPIC_LIST: // 获取有 unit_sub 的主题列表
                return this.getHasUnitSubTopicList(ctx, request);
            case RequestCode.GET_HAS_UNIT_SUB_UNUNIT_TOPIC_LIST: // 这是啥子意思 hhc1?
                return this.getHasUnitSubUnUnitTopicList(ctx, request);
            case RequestCode.UPDATE_NAMESRV_CONFIG: // 更新 nameServer 的配置
                return this.updateConfig(ctx, request);
            case RequestCode.GET_NAMESRV_CONFIG: // 获取 nameServer 的配置
